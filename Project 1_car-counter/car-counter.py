...
cap = cv2.VideoCapture("../videos/cars-video-yolo.mp4")
...
mask = cv2.imread("mask-png.png")

tracker = Sort(max_age=17, min_hits=3, iou_threshold=0.3)

limits = [97, 397, 673, 397]
totalCount = []
